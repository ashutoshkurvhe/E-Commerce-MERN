...
const EditProductPage = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      setProductData((prevData) => ({
        ...prevData, image: [...prevData.images, { url: data.imageUrl, altText: "" }],
      }));
    } catch (error) {
      console.error(error)
      setUploading(false);
  ...
  return (
    <div className="max-5xl mx-auto p-6 shadow-md rounded-md">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            onChange={handleChange}
            className="w-full border border-gray-300 rounded-mb p-2"
            row={4}
            required
          ></textarea>
        </div>
