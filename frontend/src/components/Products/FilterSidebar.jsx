...
const FilterSidebar = () => {
  ...
  const updateURLParams = (newFilters) => {
    ...
    navigate(`?${params.toString()}`); //?category=Top+Wear&size=XS%2CS
  };

  const handlePriceChange = (e) => { 
    const newPrice = e.target.value;
    setPriceRange([0, newPrice]);
    const newFiltets = { ...filters, minPrice: 0, maxPrice: newPrice };
    setFilters(newFiltets);
    updateURLParams(newFiltets);
  }
