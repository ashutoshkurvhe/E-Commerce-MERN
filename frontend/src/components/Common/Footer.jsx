        ...
        <div>
          ...
          <form className="flex">
            <input
              ...
              className="p-3 w-full text-sm border-1 border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all"
              required
            />
            <button
              type="submit"
        ...
        <div>
          ...
          <div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
              <p className='text-white text-sm tracking-tighter text-center'>
                  ©2025, fabrica. All Rights Reserved.
              </p>
          </div>
    </footer>
  );
