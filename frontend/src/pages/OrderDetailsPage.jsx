      ...
      {!orderDetails ? (
        ...
        <div className="p-4 sm:p-6 rounded-lg border">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              <h4 className="text-lg font-semibold mb-2">Shopping info</h4>
              <p>Shopping Method: {orderDetails.shippingMethod}</p>

              <p>
                Address:{""}
                {`${orderDetails.shippingAddress.city},${orderDetails.shippingMethod.country}`}
              </p>
            </div>
          </div>
          {/* Product list */}
